        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white bg-opacity-10 backdrop-blur-md rounded-xl p-8">
            <h1 className="text-3xl font-bold mb-6 text-center">
              Rejoindre le <span className="text-yellow-400">Hackathon</span>
            </h1>
          ...
          {notifications.map((notification) => (
            <div
              ...
              className={`px-4 py-3 rounded-lg shadow-lg backdrop-blur-md transition-all duration-300 animate-slide-in-right ${
                ...
                notification.type === 'milestone' ? 'bg-purple-500 bg-opacity-90 border-l-4 border-purple-300' :
        ...
        <div className="flex justify-center items-center gap-6 mb-6">
          ...
          {progressStats && (
            <div className="flex gap-4">
              <div className="bg-gray-800 rounded-lg px-4 py-2 border border-purple-500">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <button
                ...
                className="w-full bg-blue-600 hover:bg-blue-700 px-4 py-2 rounded-lg font-medium transition-colors duration-200"
              >
